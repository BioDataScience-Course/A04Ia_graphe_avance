...
<!--# La signification des variables et les unités sont expliquée ici: https://archive.ics.uci.edu/ml/datasets/Chronic_Kidney_Disease (le nom des variables est conservé, mais les niveaux, les labels et les unités sont françisés) -->
...
<!--# Lorsque vous aurez terminé, assurez-vous que le document compile (bouton 'Knit') sans erreurs et que vous avez conservé la structure intiale du document, en particulier les labels des chunks. -->
